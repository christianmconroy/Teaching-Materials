...
iterations = 10000 # Run 10,000 iterations of LDA to optimize the latent topics of the four sentences
...
# We can see documents being changed to different topics. Even after 10,000, doc 7 is bounding around between topics and it is seemingly random 
# This is why it is good to look at word co-occurenace and hypaxies before to understand what will add noise 
